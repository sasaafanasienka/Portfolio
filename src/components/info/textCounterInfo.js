...
<div className='info__container'>
    ...
    <p className='info info_text'>Учебный проект, который я придумал еще на прошлой работе. 
    ...
    <ul className='info info_list'>
        ...
        <li className='info info_text'>Есть возможность выбора между светлой и темной темой (React Context)</li>
